...
public class Buy {
    public static String main() {
        ...
        try {
            ...
            System.out.println("Какую валюту вы хотите продать?");
            ...
            ;
            if (s.equals("Yes")) {
                String sql = "INSERT INTO sell_currency (currency_id, sum_sell_currency, date_buy)" + "VALUES (?, ?, ?)";
                ...
                PreparedStatement st = connection.prepareStatement("UPDATE currency SET sum_currency = sum_currency - ? WHERE currency_id = ? ");
                st.setDouble(1, c);
                st.setInt(2, n);
                st.executeUpdate();
                st.close();
